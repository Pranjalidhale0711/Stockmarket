...
const HomePage = () => {
  ...
  return (
    ...
    <h1 className="text-7xl m-2 font-bold mt-9 font mb-4 text-[#52057B] text-center text-decoration-line: ">TradeWise</h1>
    <div className="flex flex-col sm:flex-row items-center justify-center flex-1 px-4 py-8">
      <div className="text-center sm:max-w-[50%] sm:text-left sm:mr-4">
        ...
        <p className="mb-2 text-5xl sm:text-5xl font-bold" style={{ backgroundImage: 'linear-gradient(to right, #B030B0, #602080, #202060)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>
          Skill up and practice zero-risk trading on our free TradeWise account.
        </p>
          <p className="mb-2 sm:text-2xl text-2xl text-[#202060] font-bold">
      ...
      <div className="hidden sm:block">
        <Lottie animationData={animation} className="max-w-1/2" />
      </div>
    </div>
  </div>
