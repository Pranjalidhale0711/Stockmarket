    ...
    <>
      <div className='navbar' style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px" }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <Link to='#' className='sidebar-icons' style={{ marginLeft: "-10px" }}>
        ...
        >
          <CiLogout style={{ marginBottom: "5px", marginRight: "5px"}} />
          <h5 className="text-l font-bold" style={{ textAlign: "center", textDecoration: "none" }}>
            Logout
          </h5>
        </div>
      </div>
